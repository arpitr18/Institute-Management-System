...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    UpdateTeacher() {
        ...
        JLabel lblcouresultSete = new JLabel("Education");
        ...
        try {
            ...
            while(resultSet.next()) {
                ...
                labelEmpId.setText(resultSet.getString("empId"));
                tfcouresultSete.setText(resultSet.getString("education"));
                tfbranch.setText(resultSet.getString("department"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "update teacher set address='"+address+"', phone='"+phone+"', email='"+email+"', education='"+couresultSete+"', department='"+branch+"' where empId='"+empId+"'";
                Conn con = new Conn();
